    ...
    <section id="why" className="bg-secondary text-background px-[40px] lg:px-[90px] pt-15 pb-10">
          <div className="container space-y-8">
            ...
            <div className="mt-18 grid gap-8 md:grid-cols-3">
              ...
              <div data-aos="flip-left" data-aos-duration="2000" data-aos-delay="500" data-aos-once="true" className="flex flex-col items-center text-center space-y-3 p-6 border border-primary rounded-xl">
                <div className="flex justify-center items-center gap-3">
              ...
              <div data-aos="flip-left" data-aos-duration="2000" data-aos-delay="700" data-aos-once="true" className="flex flex-col items-center text-center space-y-3 p-6 border border-primary rounded-xl">
                <div className="flex justify-center items-center gap-3">
            ...
            <div data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-duration="1000" data-aos-offset="0" data-aos-once="true" className="flex justify-center items-center mt-8">
